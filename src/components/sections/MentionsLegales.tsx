...
const MentionsLegales = () => (
  <section className="min-h-screen flex items-center justify-center bg-gray-50 py-16 px-2">
    <div className="max-w-2xl w-full bg-white rounded-2xl shadow-xl p-8 md:p-12">
      ...
      <p className="mb-4">
        ...
        <a href="https://www.netlify.com" target="_blank" rel="noopener" className="underline text-primary">www.netlify.com</a>
      </p>
