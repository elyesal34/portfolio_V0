    ...
    >
      <div className="max-w-7xl mx-auto px-4 py-20">
        <div className="text-center mb-16">
          <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6">Contactez-moi</h2>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 max-w-6xl mx-auto">
          ...
          <div className="bg-white rounded-xl shadow-lg p-8">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="pt-2">
                ...
                <button
                  type="submit"
                  className="w-full flex items-center justify-center space-x-2 bg-gradient-to-r from-blue-600 to-purple-600 text-white px-6 py-4 rounded-lg hover:from-blue-700 hover:to-purple-700 transition-all font-medium shadow-lg transform hover:scale-[1.02] disabled:opacity-50 disabled:cursor-not-allowed"
                  disabled={!isVerified}
                >
          ...
          <div className="space-y-8">
            ...
            {/* Réseaux sociaux */}
            <div className="pt-4">
              <h4 className="text-xl font-semibold text-gray-900 mb-4">Réseaux sociaux</h4>
            ...
            <div className="md:flex items-center justify-between">
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center justify-center space-x-2 bg-white text-blue-600 px-6 py-3 rounded-lg hover:bg-blue-50 transition-all font-medium shadow-lg transform hover:scale-105"
                >
                ...
                <a
                  ...
                  className="inline-flex items-center justify-center space-x-2 bg-blue-700 text-white px-6 py-3 rounded-lg hover:bg-blue-800 transition-all font-medium shadow-lg transform hover:scale-105"
                >
