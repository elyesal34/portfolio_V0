...
const Accueil = () => {
  ...
  return (
    <section id="accueil" className="min-h-screen pt-16 bg-gradient-to-br from-gray-900 via-blue-900 to-purple-900 text-white relative overflow-hidden">
        ...
        <div className="flex flex-col lg:flex-row items-center justify-between min-h-[80vh]">
          ...
          <div className="lg:w-1/2 mt-12 lg:mt-0 relative animate-fade-in" style={{ animationDelay: '1s' }}>
            <div className="relative">
              <picture>
                <source 
                  srcSet="https://images.unsplash.com/photo-1498050108023-c5249f4df085?auto=format&fit=crop&w=800&q=80&fm=webp" 
                  type="image/webp"
                />
                <img
      ...
      {/* Vague décorative - Optimisée avec lazy loading */}
      <div className="absolute bottom-0 left-0 right-0">
        <svg viewBox="0 0 1200 120" preserveAspectRatio="none" className="w-full h-16 fill-gray-50" aria-hidden="true" loading="lazy">
