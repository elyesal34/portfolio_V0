...
// Classes prédéfinies pour les largeurs de 0% à 100%
const widthClasses = [
  ...
  'w-[90%]', 'w-[91%]', 'w-[92%]', 'w-[93%]', 'w-[94%]', 'w-[95%]', 'w-[96%]', 'w-[97%]', 'w-[98%]', 'w-[99%]', 'w-full'
];
...
const ProgressBar: React.FC<ProgressBarProps> = ({
  ...
  // Obtenir la classe de largeur correspondante
  const widthClass = widthClasses[roundedLevel] || 'w-0';
  ...
  return (
    ...
    >
      <div 
        className={`h-2 rounded-full ${levelColor} transition-all duration-300 ${widthClass}`}
        aria-hidden="true"
      />
    </div>
  );
